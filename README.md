...
> 
    ...
    -  :wq (salva e sai)
>
> **Detalhe**: para se mover sem problemas, clique em ESC e use as teclas de seta pra cima, baixo, etc. Estarei deixando um vídeo para auxiliar no uso do vi, na seção das [referências](https://github.com/Yyfii/NginxServer/edit/main/README.md#step-6-criando-o-script-de-valida%C3%A7%C3%A3o)
